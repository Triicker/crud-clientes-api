...
- **Async/Await**: Use sempre `async/await`. Como o projeto usa **Express 5**, o tratamento de erros assíncronos é nativo (não precisa de `express-async-errors`), mas use `try/catch` para lógica de erro específica.
